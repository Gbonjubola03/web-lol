...
class queryModel extends Dbh {
    ...
    public function limit($table,$clm,$purchase_orders,$mode,$limit,$parm=false,$value=false,$where_in=false) {
    
    $conn = $this->connect();
    
    if (!$where_in):
     $sql = "select $clm from ".$this->pfx."$table order by $purchase_orders $mode limit $limit";
     $result = $conn->query($sql);
    else:
        
    $where_in = str_replace(',',' and ',$where_in);
    $pre = $conn->prepare("select $clm from ".$this->pfx."$table where $where_in order by $purchase_orders $mode limit $limit");
    ...
    if ($count > 21):
     errorAndDie('Query failed For Limited insert column up to 22');
    endif;
    ...
    $pre->bind_param($parm, $arr[0],$arr[1],$arr[2],$arr[3],$arr[4],$arr[5],$arr[6],$arr[7],$arr[8],$arr[9],$arr[10],$arr[11],$arr[12],$arr[13],$arr[14],$arr[15],$arr[16],$arr[17],$arr[18],$arr[19]);
    break;
    ...
    $pre->bind_param($parm, $arr[0],$arr[1],$arr[2],$arr[3],$arr[4],$arr[5],$arr[6],$arr[7],$arr[8],$arr[9],$arr[10],$arr[11],$arr[12],$arr[13],$arr[14],$arr[15],$arr[16],$arr[17],$arr[18],$arr[19],$arr[20]);
    break;
    case '21':

    $pre = $conn->prepare("insert into ".$this->pfx."$table ($clm) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");

    $pre->bind_param($parm, $arr[0],$arr[1],$arr[2],$arr[3],$arr[4],$arr[5],$arr[6],$arr[7],$arr[8],$arr[9],$arr[10],$arr[11],$arr[12],$arr[13],$arr[14],$arr[15],$arr[16],$arr[17],$arr[18],$arr[19],$arr[20],$arr[21]);
    break;
    }
