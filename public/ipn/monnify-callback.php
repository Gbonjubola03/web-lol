...
// Replace with your Monnify secret key
$secret_key = do_config(46);

$curl = curl_init();

// Update URL to Monnify verification endpoint
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://sandbox.sdk.monnify.com/checkout/".$_GET["transactionReference"],
...
if ($err) {
  ...
  // Update query to check for Monnify specific fields
  $invoice = $query->addquery('select','invoice','*','s',$response->data->transactionReference,'token=?');
