...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.$container = $('<div class="bootstrap-tagsinputa"></div>');
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal, options) {
      ...
      var $tag = $('<span class="' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + htmlEncode(itemText) + '<span class="tag-remover" data-role="remove"></span></span>');
      $tag.data('item', item);
