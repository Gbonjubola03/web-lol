...
class QorepayApi {
	...
	public function __construct($brandId, $apiKey, $base = 'https://gate.qorepay.com/api/v1/', $config = []) {
	...
	/**
	 * 
	 * @param \Qorepay\Model\Purchase $purchase
	 * @return \Qorepay\Model\Purchase
	 */
