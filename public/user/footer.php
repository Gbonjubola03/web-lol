        ...
        <div class="row">
            ...
            <ul class="list-unstyled list-inline list-social mb-6 mb-md-0">
              <?php if (!empty(do_config(2))){ ?>
                <li class="list-inline-item list-social-item me-3">
                  <a href="<?php echo do_config(2); ?>" class="text-decoration-none"></a>
                </li>
              <?php } ?>
            </ul>
          </div>
          ...
          <div class="col-6 col-md-5 col-lg-3">
            ...
            <ul class="list-unstyled text-body-secondary mb-6 mb-md-8 mb-lg-0">
              <?php 
              // Check if $pages is defined and is an object with fetch_assoc method
              if (isset($pages) && is_object($pages) && method_exists($pages, 'fetch_assoc')) {
                while($res = $pages->fetch_assoc()){ 
              ?>
                <li class="mb-3">
              ...
              <?php 
                ...
                // Fallback if $pages is not available
                echo '<li class="mb-3"><a href="' . do_config(14) . '" class="text-reset">Home</a></li>';
              }
              ?>
            </ul>
          </div>
    ...
    <script>
      // Ensure ads are not visible by the site's own code
