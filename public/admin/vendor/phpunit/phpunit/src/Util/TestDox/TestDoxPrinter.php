...
class TestDoxPrinter extends DefaultResultPrinter
{
    ...
    public function setOriginalExecutionOrder(array $purchase_orders): void
    {
        $this->originalExecutionOrder = $purchase_orders;
        $this->enableOutputBuffer     = !empty($purchase_orders);
    }
