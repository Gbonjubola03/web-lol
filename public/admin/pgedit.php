...
<?php do_winfo('EDIT PAGE'); ?>
    ...
    <main class="app-content">
      ...
      <div class="bs-component">
          <div class="card">
              <h4 class="card-header"> EDIT PAGE #<?php echo $_GET["id"];?></h4>
              <div class="card-body">
                  <div class="row">
                      <div class="col-md-12">
                        ...
                        ?>
                          ...
                          <span id="editpage-response"></span>
                          <!-- ALERTS RESPONSE END HERE -->
                          <form id="editpage_form" autocomplete="off" method="POST">
                            ...
                            <div class="row mb-10">
                              <div class="col-md-12">
                                <button type="button" onclick="editpageForm();" id="editpage-button" class="btn btn-primary">
