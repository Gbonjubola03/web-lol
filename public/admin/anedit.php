...
<?php do_winfo('EDIT ANNOUNCEMENT'); ?>
    ...
    <main class="app-content">
      ...
      <div class="bs-component">
          <div class="card">
              <h4 class="card-header"> EDIT ANNOUNCEMENT #<?php echo $_GET["id"];?></h4>
              <div class="card-body">
                  <div class="row">
                      <div class="col-md-12">
                        ...
                        ?>
                          ...
                          <span id="editannouncement-response"></span>
                          <!-- ALERTS RESPONSE END HERE -->
                          <form id="editannouncement_form" autocomplete="off" method="POST">
                              <input type="hidden" name="editannouncement" value="editannouncement" />
                            ...
                            <div class="row mb-10">
                              <div class="col-md-12">
                                <button type="button" onclick="editannouncementForm();" id="editannouncement-button" class="btn btn-primary">
